...
Loading package ff2.2-9
- getOption("fftempdir")=="/tmp/RtmpdDq8c4"
...
cn.farms Package Version 1.7.0

cn.farms v1.7.0 (2012-10-29) successfully loaded. See ?cn.farms for help.
> 
> ## load test data
